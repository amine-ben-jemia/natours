...
var displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    ...
    scrollZoom: false // center:[10.316870,36.832520],
    // zoom:10
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " Updated succesfully !")); // window.setTimeout(()=>{
              //     location.assign('/me')
              // },1500)
            }
...
var stripe = Stripe('pk_test_51Ho8miIeuSnbE8G7VcQDkXeV0DZ9lV5EgEurcyz0tEnfXuNCeWffHyLmCfCasMLWoAEeB4ZoVt7McXh3mjuMf1B200RmMJVp1a');
...
var bookBtn = document.getElementById('book-tour'); //DELEGRATION
